...
extern uint32_t  __MAIN_region_ROM_start__;

#define VECT_TAB_OFFSET_MAIN               ((uint32_t)&__MAIN_region_ROM_start__)
#define VECT_TAB_OFFSET_BOOTLOADER         (0)
...
void SystemInit(void)
{
    ...
    #ifdef BOOTLOADER
    SCB->VTOR = VECT_TAB_OFFSET_BOOTLOADER;
    #else
    SCB->VTOR = VECT_TAB_OFFSET_MAIN;
    #endif
